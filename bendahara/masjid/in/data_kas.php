<div class="alert alert-success alert-dismissible fade show" role="alert">
    ...
    <div class="d-flex align-items-center">
        <div>
            <h4 class="alert-heading mb-1"><i class="fas fa-info-circle"></i> Pemasukan Kas Masjid</h4>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Kas Masjid Masuk</h6>
    </div>
    <div class="card-body">
        <div class="mb-3">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="?page=i_edit_km&kode=<?php echo $data['id_km']; ?>" title="Ubah" class="btn btn-success btn-circle btn-sm">
                                    <i class="bi bi-pencil-fill"></i>
                                </a>
                                <a href="?page=i_del_km&kode=<?php echo $data['id_km']; ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')" title="Hapus" class="btn btn-primary btn-circle btn-sm">
